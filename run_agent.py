...
class AIAgent:
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        if "kanban_show" in self.valid_tool_names:
            ...
            tool_guidance_labels.append("kanban_guidance")
        if tool_guidance:
        ...
        if platform_key in PLATFORM_HINTS:
            ...
            try:
                ...
                if _entry and _entry.platform_hint:
                    ...
                    _manifest.append(("platform_hint_plugin", _entry.platform_hint))
            except Exception:
                pass
        ...
        if not pre_tool_block_checked:
            try:
                ...
                block_message = get_pre_tool_call_block_message(
                    ...
                    session_id=self.session_id or "", tool_call_id=tool_call_id or "",
                )
            except Exception:
                pass
    ...
    def _execute_tool_calls_concurrent(self, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0) -> None:
        ...
        for tool_call in tool_calls:
            ...
            try:
                ...
                block_message = get_pre_tool_call_block_message(
                    function_name, function_args, task_id=effective_task_id or "",
                    session_id=self.session_id or "", tool_call_id=tool_call.id or "",
                )
            except Exception:
                block_message = None
